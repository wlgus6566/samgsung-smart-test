...
export default function HeadBreadcrumb() {
  ...
  return (
    <div className="absolute left-0 bottom-0 w-full py-[18px] px-[40px] bg-white rounded-[var(--radius)] rounded-b-none">
          ...
          {mounted &&
            segments.map((segment, index) => {
              ...
              return (
                <Fragment key={href}>
                  {index !== 0 && (
                    <BreadcrumbSeparator className="mx-[20px]">
                      <Img
                        src="/images/icon/ic_arrow_right_black.svg"
                        alt="chevron-right"
                        width={24}
                        height={24}
                        priority={true}
