...
export default function NoticeResultDetail({ id, initialData }) {
  const {
    ...
    error,
    isLoading,
  } = useSWR(`/api/v1/bbs/NOTICE/${id}`, {
    fallbackData: initialData,
    dedupingInterval: 1000,
  });

  return (
    <Contents title="공지사항" backgroundImage="/images/event/event_kv_bg.jpg">
      <PostState
        isLoading={isLoading}
        error={error}
        data={result}
              ...
              prevPost={
                result.prev
                  ? {
                      ...
                      url: `/yoga/notice/${result.prev.boardSeq}`,
                    }
                  : null
              }
              nextPost={
                result.next
                  ? {
                      ...
                      url: `/yoga/notice/${result.next.boardSeq}`,
                    }
                  : null
              }
            />
