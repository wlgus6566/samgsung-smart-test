...
export default function RegulationsList({ initialData }) {
  ...
  const { data, error, isLoading } = useSWR(
    `/api/v1/bbs/REGULATION?searchWord=${encodeURIComponent(searchWord)}&currentPage=${currentPage}&size=10`,
    fetcher,
    {
  ...
  return (
    <Contents title="정관/규정" backgroundImage="/images/kya/kya_kv_bg.jpg">
